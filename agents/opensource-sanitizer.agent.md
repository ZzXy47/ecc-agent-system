...
Verify an open-source fork is fully sanitized. Scans for leaked secrets, PII, internal references using 20+ regex patterns.
...
### Step 3: Internal Reference Scan
- 内部域名
- 公司名称
- 员工姓名
...
- Secrets found: X
- PII found: X
- Internal refs found: X

### Critical Findings
1. [CRITICAL] file:line — secret type

### Warnings
1. [WARNING] file:line — PII type
